<template>
    <div>
        ...
        <div class="page-table" style="overflow:hidden;">
                                    ...
                                    <div class="pre_menu_list" id="menuList">
                                        <el-popover ref="popover1" placement="top">
                                            <div style="width:88px;" id="pop0">
                                                <el-button class="button_text" v-for="sub,index in sub_button1" :key="index" style="display:block;width:100%;margin-left:0px;border-radius:0px;border:0px;border-bottom:1px solid #bfcbd9;padding:10px 10px;" @click="setSubMenu(sub)">{{sub.name}}</el-button>
                                        ...
                                        <el-popover ref="popover2" placement="top">
                                            <div style="width:88px;" id="pop1">
                                                <el-button class="button_text" v-for="sub,index in sub_button2" :key="index" style="display:block;width:100%;margin-left:0px;border-radius:0px;border:0px;border-bottom:1px solid #bfcbd9;padding:10px 10px;" @click="setSubMenu(sub)">{{sub.name}}</el-button>
                                        ...
                                        <el-popover ref="popover3" placement="top">
                                            <div style="width:88px;" id="pop2">
                                                <el-button class="button_text" v-for="sub,index in sub_button3" :key="index" style="display:block;width:100%;margin-left:0px;border-radius:0px;border:0px;border-bottom:1px solid #bfcbd9;padding:10px 10px;" @click="setSubMenu(sub)">{{sub.name}}</el-button>
...
<style scoped>
    ...
    .mobile_menu_preview {
        ...
        width: 317px;
        height: 560px;
        background: transparent url(/img/mobile_head.png) no-repeat 0 0;
    ...
    .menu_preview_area .pre_menu_list {
        ...
        background: transparent url(/img/mobile_foot.png) no-repeat 0 0;
        background-position: 0 0;
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getData(){
                this.loading = true;
                axios.post("/admin/weixin/menu/get").then(response => {
            ...
            saveMenu() {
                if(this.button_show){
                    this.$refs['form'].validate((valid) => {
                        ...
                        if (valid) {
                            this.loading = true;
                            axios.post("/admin/weixin/menu/set", {data: this.menus}).then(response => {
                                this.loading = false;
